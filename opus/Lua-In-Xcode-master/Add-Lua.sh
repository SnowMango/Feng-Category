...
<plist version="1.0">
<dict>
    <key>Xcode.MagicFileDataTypeDetector.Lua</key>
    <dict>
        <key>detectedTypeIdentifier</key>
        <string>com.apple.xcode.lua-source</string>
        <key>id</key>
        <string>Xcode.MagicFileDataTypeDetector.Lua</string>
        <key>magicWordString</key>
        <array>
            <dict>
                <key>string</key>
        ...
        <key>name</key>
        <string>Lua Script Magic File Data Type Detector</string>
        <key>point</key>
        <string>Xcode.MagicFileDataTypeDetector</string>
        <key>version</key>
        <string>0.1</string>
    </dict>
